...
namespace ape {
  namespace visualization {
    ...
    public:
      ...
      bool Raycast(Ogre::Ray& ray, Ogre::uint32 queryMask,
        Ogre::Vector3& result, Ogre::MovableObject** resultObj,
        size_t& resultSubIdx);
    ...
    private:
      ...
      static void GetSubMeshInformation(const Ogre::MeshPtr mesh,
        const size_t subMeshIndex, size_t &vertex_count,
      ...
      static void GetSubMeshInformation(const Ogre::ManualObject* manual,
        const size_t subMeshIndex, size_t& vertex_count,
        Ogre::Vector3*& vertices, size_t& index_count, unsigned long*& indices,
        const Ogre::Vector3& position, const Ogre::Quaternion& orient,
        const Ogre::Vector3& scale);

      static void GetSubMeshInformation(const Ogre::Entity* entity,
        const size_t subMeshIndex, size_t& vertex_count,
        Ogre::Vector3*& vertices, size_t& index_count, unsigned long*& indices,
        const Ogre::Vector3& position, const Ogre::Quaternion& orient,
        const Ogre::Vector3& scale);
